package com.censoft.project.tool.gen.util;

import java.util.ArrayList;
import java.util.List;
import org.apache.velocity.VelocityContext;
import com.censoft.common.constant.Constants;
import com.censoft.common.constant.CommonMap;
import com.censoft.common.utils.DateUtils;
import com.censoft.common.utils.StringUtils;
import com.censoft.framework.config.GenConfig;
import com.censoft.project.tool.gen.domain.ColumnInfo;
import com.censoft.project.tool.gen.domain.TableInfo;
...
{
    /** 项目空间路径 */
    private static final String projectPath = "main/java/com/censoft/project";
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(getModuleName("com.censoft.project.system"));
    }
}
