package com.censoft.project.tool.gen.controller;
...
import com.censoft.project.tool.gen.service.IGenService;
...
public class GenController extends BaseController
{
    ...
    public void genCode(HttpServletResponse response, @PathVariable("tableName") String tableName) throws IOException
    {
        ...
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"censoft.zip\"");
